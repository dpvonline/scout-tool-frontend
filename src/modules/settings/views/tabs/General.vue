<template>
  <div>
      ...
      <div class="mt-6">
        <dl class="divide-y divide-gray-200">
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
            <dt class="text-sm font-medium text-gray-500">Nutzername</dt>
          ...
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
            ...
            <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <span class="flex-grow"
                >{{ personalData.firstName }} {{ personalData.lastName }}</span
              >
            </dd>
          </div>
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
          ...
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
            ...
            <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <span class="flex-grow">{{
                moment(personalData.birthday).format("DD.MM.YYYY")
              }}</span>
            </dd>
          </div>
          <div
    ...
    <div class="mt-10 divide-y divide-gray-200">
      <div class="space-y-1">
        <h3 class="text-lg font-medium leading-6 text-gray-900">Kontakt</h3>
      ...
      <div class="mt-6">
        <dl class="divide-y divide-gray-200">
          ...
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
            ...
            <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <span class="flex-grow">{{
                personalData.addressSupplement
              }}</span>
            </dd>
          </div>
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
            ...
            >
              <span
                ...
                {{ personalData.zipCode?.city || "" }}</span
              >
            </dd>
          </div>
        </dl>
      ...
      <div class="mt-6">
        <dl class="divide-y divide-gray-200">
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:pt-5">
            ...
            <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <span class="flex-grow">{{
                personalData.eatHabits?.map((item) => item.name).join(", ") ||
                "-"
              }}</span>
            </dd>
          </div>
    ...
    <div class="mt-10 divide-y divide-gray-200">
      <div class="space-y-1">
        <h3 class="text-lg font-medium leading-6 text-gray-900">Rollen</h3>
        <p class="max-w-2xl text-sm text-gray-500">
      ...
      <div class="mt-6">
        <dl class="divide-y divide-gray-200">
          ...
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:pt-5">
            ...
            <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <span class="flex-grow">{{ personalData.scoutLevel }}</span>
            </dd>
          </div>
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:pt-5">
            <dt class="text-sm font-medium text-gray-500">Position</dt>
            <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <span class="flex-grow">{{ personalData.leader }}</span>
            </dd>
          </div>
        </dl>
      </div>
      ...
      <div class="mt-6">
        <dl class="divide-y divide-gray-200">
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:pt-5">
            ...
            <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <span class="flex-grow">{{ personalData.bundespost }}</span>
            </dd>
          </div>
          <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:pt-5">
            <dt class="text-sm font-medium text-gray-500">
            ...
            <dd class="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <span class="flex-grow">{{
                personalData.emailNotification
              }}</span>
            </dd>
          </div>
          <SwitchGroup
