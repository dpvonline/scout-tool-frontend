  ...
  return [
    {
      ...
      name: "",
      description: "",
      link: "RegistrationNewStart",
      status: getStatus("RegistrationNewStart", [
        "RegistrationNewPerson",
        "RegistrationNewTravel",
    ...
    },
    {
      id: 2,
      name: "",
      link: "RegistrationNewPerson",
      status: getStatus("RegistrationNewPerson", [
        "RegistrationNewTravel",
        "RegistrationNewFreeText",
        "RegistrationNewSummary",
      ]),
    ...
    },
    {
      id: 4,
      name: "",
      link: "RegistrationNewFreeText",
      status: getStatus("RegistrationNewFreeText", [
        "RegistrationNewSummary",
      ]),
    },
    {
      id: 5,
      name: "",
      link: "RegistrationNewSummary",
      status: getStatus("RegistrationNewSummary", [
      ]),
    },
  ];
});
