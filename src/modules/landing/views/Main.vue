<template>
  <div class="bg-white">
    <div
      class="relative isolate overflow-hidden bg-gradient-to-b from-blue-100/20"
    >
      <div
        class="
          mx-auto
          ...
          pb-24
          sm:pb-32
          lg:grid lg:grid-cols-2 lg:gap-x-8 lg:py-40 lg:px-8
        "
      >
            ...
            <div class="max-w-lg">
              ...
              <div class="mt-10 flex items-center gap-x-6">
                ...
                <router-link
                  ...
                  class="inline-flex
                    items-center text-base font-semibold leading-7 text-gray-900"
                  >
  ...
  <footer class="bg-white">
    <div class="mx-auto max-w-7xl overflow-hidden py-4 px-6 sm:py-4 lg:px-8">
      ...
      <p class="mt-10 text-center text-xs leading-5 text-gray-500">&copy; 2023 Deutscher Pfadfinderverband</p>
    </div>
  </footer>
  </div>
</template>
