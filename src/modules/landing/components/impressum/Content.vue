  ...
  <div class="relative overflow-hidden bg-white py-16">
    ...
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-prose text-lg">
        ...
        <h2 class="mt-8 text-l leading-8 text-gray-500">
          Angaben gemäß § 5 TMG
        </h2>

        <p class="mt-8 text-sm leading-8 text-gray-500">
      ...
      <a
        ...
        href="https://dpvonline.de/impressum/"
      >
      ...
      <div class="prose prose-lg prose-blue mx-auto mt-6 text-gray-500">
        ...
        <a
          rel="license"
          class="mt-8 text-sm leading-8 text-gray-500"
          href="https://creativecommons.org/licenses/by-nc/4.0/deed.de"
        >
